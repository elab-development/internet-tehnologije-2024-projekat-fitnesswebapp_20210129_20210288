...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\ITEH\internet-tehnologije-2024-projekat-fitnesswebapp_20210129_20210288\Domaci1\fitness-web-app\public\storage' => 'string',
...
'auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.guards.api.driver','auth.guards.api.provider','auth.providers.users.driver',
...
'filesystems.links.D:\\ITEH\\internet-tehnologije-2024-projekat-fitnesswebapp_20210129_20210288\\Domaci1\\fitness-web-app\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'sanctum.guard','sanctum.expiration','sanctum.token_prefix','sanctum.middleware','services.postmark.token',
...
'sanctum.csrf-cookie',
'workouts.index','workouts.store','workouts.show','workouts.update','workouts.destroy','exercises.index','exercises.store',
'exercises.show','exercises.update','exercises.destroy','goals.index','goals.store','goals.show','goals.update',
'goals.destroy','verification.verify','register',
'login','password.email','password.store','verification.send','logout','storage.local',);
...
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','SANCTUM_STATEFUL_DOMAINS','SESSION_DRIVER',
